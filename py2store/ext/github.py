...
class Branches(KvReader):
    ...
    def __getitem__(self, k):
        ...
        return BranchDir(self._source_obj, branch_name=k,
                         path="", content_file_extractor=self.content_file_extractor)
...
class BranchDir(KvReader):
    def __init__(self, repository_obj, branch_name, path="",
    ...
    def __repr__(self):
        return format_invocation(self.__class__.__name__,
                                 (self._source_obj, self.branch_name, self.path, self.content_file_extractor))
